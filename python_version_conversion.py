...
# Get the attn labels
labels = np.load('/home/lili/Video/spatial_temporal_LSTM/att_result/att_all_valid_labels_6.npy').reshape(-1)
logits = np.load('/home/lili/Video/spatial_temporal_LSTM/att_result/att_all_valid_logits_6.npy').reshape(-1, 339)
names = np.load('/home/lili/Video/spatial_temporal_LSTM/att_result/att_all_valid_names_6.npy').reshape(-1)
...
np.save('/home/lili/Video/moments_ensemble/data/attention_LSTM/attn_logits_6.npy', sorted_logits)
np.save('/home/lili/Video/moments_ensemble/data/attention_LSTM/attn_labels_6.npy', conv_labels)